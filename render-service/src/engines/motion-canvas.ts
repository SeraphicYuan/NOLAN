...
// Embedded icons for staircase (and other effects)
// NOTE: These are intentionally duplicated from assets/index.ts because this code
// is written as a string to a generated Motion Canvas scene file. The Motion Canvas
// renderer runs in a separate context and cannot import from our TypeScript modules.
// Keep in sync with assets/index.ts when adding new icons.
const ICONS: Record<string, string> = {
  ...
  growth: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>',
  ...
  brand: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg>',
...
// Helper to get icon SVG with color applied
