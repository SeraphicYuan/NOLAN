...
# NO TRACK-OVERLAP GATE HERE, and that is a finding, not an omission — see
# tests/test_author_track_overlap.py for the disproof. Two clips sharing a track and a moment is LEGAL
# inside a frame's sub-composition; gating on it (twice attempted) blocks legitimate authoring.
