...
def test_a_regression_reverts_even_when_the_verdict_is_better():
    """A draft can improve on balance and still have broken a beat — and that beat is the
    cheapest thing in the loop to fix, being known, located and recent."""
