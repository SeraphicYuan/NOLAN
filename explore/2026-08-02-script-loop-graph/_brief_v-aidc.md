# NOLAN pairwise REVIEW: "AI Data Center Debate [VALIDATE]"
...
- **previous:** `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/drafts/draft-01.md` (1318 narration words)
- **current:**  `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/drafts/draft-02.md` (1299 narration words)
...
- **Brief:** `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/brief.md`   · **Beatmap:** `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/beatmap.md`
- **Facts:** `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/facts.md`   · **Citations:** `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/citations.md`
- **Style guide (voice):** `script_styles/channel-stickman-talks/style_guide.md`
- **Length target:** ~1160 narration words; the current draft is 1299.
...
## Output → `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/reviews/review-02.pairwise.json` (a single JSON object)
```json
{
...
## Provenance — add your two fields to `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/reviews/review-02.provenance.json`
...
After `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/reviews/review-02.pairwise.json` is written, create `explore/2026-08-02-script-loop-graph/_runs/v-aidc/scriptgen/.runs/pairwise-02.done` containing one line
