# NOLAN script V3 task: "Holbein Dance of Death"
...
## Inputs
- **Brief:** `projects/holbein-dance-of-death/scriptgen/brief.md`  ·  **Style (the constitution):** `script_styles/art-stories/style_guide.md`
- **Sources manifest:** `projects/holbein-dance-of-death/scriptgen/sources/sources.md`  ·  **Fetched text:** `projects/holbein-dance-of-death/scriptgen/sources/raw/*.md`
...
text to `projects/holbein-dance-of-death/scriptgen/sources/raw/<ID>-<slug>.md`. If one fails, note it and continue.
  - (none)

## Step — Ground the facts → `projects/holbein-dance-of-death/scriptgen/facts.md`
Read `projects/holbein-dance-of-death/scriptgen/sources/sources.md` first. For any source flagged **⚠ LARGE** (e.g. a
...
## Step — Confirm the supplied angle (or improve it) → `projects/holbein-dance-of-death/scriptgen/angles.md`
FIRST, read `script_styles/art-stories/style_guide.md` and INFER the **spine type** this channel builds its videos on — from its Narrative Structure, Devices, Hook Patterns, and exemplars. (Is it a central human/thematic contrast? a biographical braid? a mystery? a mechanism/"how it works"? a data-grounded both-sides argument?) State the inferred spine type in one line at the top of angles.md.
The human SUPPLIED this angle: "Death as the great leveler — and a smuggled social/anticlerical satire on the eve of the Reformation". Treat it as the intended spine. Check it is
...
## Step — Beat-map the angle onto the guide's structure → `projects/holbein-dance-of-death/scriptgen/beatmap.md`
Plan the retention curve BEFORE drafting, using `script_styles/art-stories/style_guide.md` as the
...
## Step — Draft to the beat-map → `projects/holbein-dance-of-death/scriptgen/drafts/draft-<NN>.md`
Write the voiceover following `projects/holbein-dance-of-death/scriptgen/beatmap.md` and `script_styles/art-stories/style_guide.md`'s
...
`facts.md`; save to `projects/holbein-dance-of-death/scriptgen/drafts/draft-<NN>.md` (next unused number).

## Step — Fact-check → `projects/holbein-dance-of-death/scriptgen/factcheck.md` + `projects/holbein-dance-of-death/scriptgen/citations.md`
...
the full source list + quotes to `projects/holbein-dance-of-death/scriptgen/citations.md`. **Never present an unverified
claim as certain** in the script — soften ("it's generally held…") or cut it.

## Step — Voice pass (the style twin of the fact-check) → `projects/holbein-dance-of-death/scriptgen/stylecheck.md`
...
`projects/holbein-dance-of-death/scriptgen/stylecheck.md`:
...
## Step — Write the run report → `projects/holbein-dance-of-death/scriptgen/report.md`
...
Finally: copy your finished draft to `projects/holbein-dance-of-death/script.md` so it's Director-ready.
