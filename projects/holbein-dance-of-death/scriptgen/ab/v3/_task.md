...
## Step — Propose angles (resonant + right-type + style-fit) → `projects/holbein-dance-of-death/scriptgen/angles.md`
FIRST, read `script_styles/art-stories/style_guide.md` and INFER the **spine type** this channel
...
`script_styles/art-stories/style_guide.md`'s **Hook Patterns**, **Narrative Structure**, **Pacing
