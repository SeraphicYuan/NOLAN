# NOLAN script AUTO task: "Holbein Dance of Death"

Run the whole grounded pipeline end to end — **you choose the angle** — and produce a
finished draft. No human gate.

## Inputs
- **Brief:** `projects/holbein-dance-of-death/scriptgen/brief.md`  ·  **Style:** `script_styles/art-stories/style_guide.md`
...
## Step — Propose thesis / angles → `projects/holbein-dance-of-death/scriptgen/angles.md`
...
## Step — Draft the script → `projects/holbein-dance-of-death/scriptgen/drafts/draft-<NN>.md`
**Angle:** use the `**[CHOSEN]**` angle from angles.md.
Write the voiceover using `script_styles/art-stories/style_guide.md`'s **How to Apply**
block as your system prompt, drawing facts from `projects/holbein-dance-of-death/scriptgen/facts.md` (and raw sources for
detail). Save to `projects/holbein-dance-of-death/scriptgen/drafts/draft-<NN>.md` (next unused number — never overwrite an
...
Finally (auto mode only): copy your finished draft to `projects/holbein-dance-of-death/script.md` so it's
Director-ready.
