...
## Inputs
- **Brief:** `projects/homer/scriptgen/brief.md`  ·  **Style (the constitution):** `script_styles/channel-great-books-explained/style_guide.md`
- **Sources manifest:** `projects/homer/scriptgen/sources/sources.md`  ·  **Fetched text:** `projects/homer/scriptgen/sources/raw/*.md`
...
text to `projects/homer/scriptgen/sources/raw/<ID>-<slug>.md`. If one fails, note it and continue.
  - (none)

## Step — Ground the facts → `projects/homer/scriptgen/facts.md`
Read `projects/homer/scriptgen/sources/sources.md` first. For any source flagged **⚠ LARGE** (e.g. a
...
## Step — Beat-map the angle onto the guide's structure → `projects/homer/scriptgen/beatmap.md`
Plan the retention curve BEFORE drafting, using `script_styles/channel-great-books-explained/style_guide.md` as the
...
## Step — Draft to the beat-map → `projects/homer/scriptgen/drafts/draft-<NN>.md`
Write the voiceover following `projects/homer/scriptgen/beatmap.md` and `script_styles/channel-great-books-explained/style_guide.md`'s
...
`facts.md`; save to `projects/homer/scriptgen/drafts/draft-<NN>.md` (next unused number).

## Step — Fact-check → `projects/homer/scriptgen/factcheck.md` + `projects/homer/scriptgen/citations.md`
...
the full source list + quotes to `projects/homer/scriptgen/citations.md`. **Never present an unverified
claim as certain** in the script — soften ("it's generally held…") or cut it.

## Step — Voice pass (the style twin of the fact-check) → `projects/homer/scriptgen/stylecheck.md`
...
`projects/homer/scriptgen/stylecheck.md`:
...
## Step — Write the run report → `projects/homer/scriptgen/report.md`
...
Finally: copy your finished draft to `projects/homer/script.md` so it's Director-ready.
