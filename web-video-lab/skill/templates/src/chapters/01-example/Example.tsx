 ...
 *
 * ⚠️ ON-SCREEN LANGUAGE IS ILLUSTRATIVE ONLY. This example happens to be Chinese;
 * your chapters MUST use the article's language (declared in outline.md, e.g.
 * `On-screen language: English (en)`). Never inherit this file's language.
 * See CHAPTER-CRAFT.md «屏幕语言 / On-screen language».
 *
