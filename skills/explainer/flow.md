...
uses: [explainer.scene-grammar, explainer.script, explainer.block-catalog]
evals: []
---
...
## Grammar (`scene-grammar.md` + `script.md`)
...
## Palette
The full library (see `block-catalog.md`): HeroStatement, KineticHeadline, PullQuote,
...
UnlockGrid, ChapterCard, LottieIcon.
