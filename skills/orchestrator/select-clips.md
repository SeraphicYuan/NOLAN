---
id: orchestrator.select-clips
name: Select clips
kind: prompt
purpose: (deprecated) LLM clip-selection pass — superseded by the in-code semantic vector matcher.
status: deprecated
version: 1
handoffs:
  - { process: orchestrator, stage: select-clips }
loaded_by: []
evals: []
---
