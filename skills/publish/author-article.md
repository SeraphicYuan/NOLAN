---
id: publish.author-article
name: Author article
kind: prompt
purpose: Author the article component hierarchy from the source.
status: active
version: 1
handoffs:
  - { process: publish, stage: author-article }
loaded_by: [src/nolan/publish/builder.py]
evals: []
---
