...
from .library import add_plate, load_overlay_library, resolve_plate, stocked_effects
...
__all__ = ["REGISTRY", "BY_ID", "Effect", "FAMILIES", "METHODS", "BLEND_MODES", "FFMPEG_VF", "bakeable",
           ...
           "has_overlays", "load_overlay_library", "resolve_plate", "stocked_effects", "add_plate"]
