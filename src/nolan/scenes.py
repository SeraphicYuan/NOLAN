...
[
  {{
    ...
    "archetype": "centered-hero|editorial-column|swiss-grid|split-screen|full-bleed-overlay|focal-card|sidebar|framed|timeline|comparison-table|ledger|quadrant|asymmetric-hero",
...
- `archetype` = the scene's MACRO LAYOUT (where content sits on the frame). Pick per the BEAT, content-first:
  ...
  sidebar; a contained chart/quote/code -> framed; a two-axis 2x2 positioning matrix -> quadrant; a
  cinematic opening/chapter card (subject on a third, title opposite) -> asymmetric-hero. Do NOT
