...
# Museum / public-domain art providers, keyless first. Keyed providers are
# skipped automatically by the client when unconfigured.
ART_SOURCES = ["wikimedia", "met", "artic", "cleveland", "rijksmuseum",
