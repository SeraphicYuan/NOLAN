...
MOTION_VOCAB = {
    ...
    "atmospheric":   {"label": "atmospheric overlay", "kinds": ["image", "stock", "library"],
                      "means": "drifting particles/fog/grain — mood; makes a flat frame feel shot", "available": True},
    "rack-focus":    {"label": "rack focus", "kinds": ["image"],
                      "means": "shift attention / a realization", "available": True},
    "blur-in":       {"label": "blur → sharp reveal", "kinds": ["image", "stock"],
                      "means": "coming into focus / a reveal", "available": True},
